...
If you have 16 overtones and 16 undertones on each, you end up with 256 pitches in the tonality diamond. Many are duplicates. Eliminating duplicates you end up with 213 pitches. I added three more pitches to my collection to reduce the gaps at either end of the octave. That makes a total of 217. But the diamond itself has 213 unique pitches per octave. 
